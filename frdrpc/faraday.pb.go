...
type ForwardingAbilityResponse struct {
	...
	// pair that carried at least one forward, with its exact facts. Pairs that
	// carried none are never listed here; they are either flagged in
	// up_but_idle_bitmask or absent. Entries take precedence over the bitmask
	// for the same pair.
	...
	// the uptime_threshold fraction of effective uptime over the window but
	// carried no forward: the dense "up but idle" population. A pair with an
...
type ForwardingAbilityEntry struct {
	...
	EffectiveUptimeS uint64 `protobuf:"varint,2,opt,name=effective_uptime_s,json=effectiveUptimeS,proto3" json:"effective_uptime_s,omitempty"`
	// Total successfully forwarded amount over the window, in millisatoshis.
	ForwardedMsat int64 `protobuf:"varint,3,opt,name=forwarded_msat,json=forwardedMsat,proto3" json:"forwarded_msat,omitempty"`
	// Total fees earned on the pair's forwards over the window, in
	// millisatoshis. Fees are reported at millisatoshi granularity because a
	// single forward routinely earns less than one satoshi, and a satoshi
	// granular sum would floor a low-fee pair's earnings to zero.
	FeeMsat int64 `protobuf:"varint,4,opt,name=fee_msat,json=feeMsat,proto3" json:"fee_msat,omitempty"`
	// The number of successful forwards the pair carried over the window. It
	// decides whether the pair forwarded at all, since the fee total can be
	// zero for one that did under a zero-fee policy. With forwarded_msat it
	// also gives the mean forward size.
	Forwards int64 `protobuf:"varint,5,opt,name=forwards,proto3" json:"forwards,omitempty"`
}
...
func (x *ForwardingAbilityEntry) GetEffectiveUptimeS() uint64 {
	if x != nil {
...
func (x *ForwardingAbilityEntry) GetForwardedMsat() int64 {
	if x != nil {
		return x.ForwardedMsat
	}
	return 0
}

func (x *ForwardingAbilityEntry) GetFeeMsat() int64 {
	if x != nil {
		return x.FeeMsat
	}
	return 0
...
func (x *ForwardingAbilityEntry) GetForwards() int64 {
	if x != nil {
		return x.Forwards
	}
	return 0
...
var file_faraday_proto_rawDesc = []byte{
	...
	0x70, 0x74, 0x69, 0x6d, 0x65, 0x54, 0x68, 0x72, 0x65, 0x73, 0x68, 0x6f, 0x6c, 0x64, 0x22, 0xc3,
	...
	,
	...
	,
	...
	,
	...
	,
