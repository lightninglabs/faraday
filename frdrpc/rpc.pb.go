...
const (
	...
	//
	//Sweep of an individual on chain htlc with the preimage, associated with a
	//sub-atomic swap. Note that these transactions will only detect swaps
	//with the same script structure as Lightning Labs Loop.
	EntryType_SWAP_SUCCESS EntryType = 15
	// Fees for sweeping on chain htlc with the preimage.
	EntryType_SWAP_SUCCESS_FEE EntryType = 16
	//
	//Sweep of an individual on chain htlc with the timeout clause, associated
	//with a sub-atomic swap. Note that these transactions will only detect swaps
	//with the same script structure as Lightning Labs Loop.
	EntryType_SWAP_TIMEOUT EntryType = 17
	// Fees for sweeping an on chain htlc with the timeout clause.
	EntryType_SWAP_TIMEOUT_FEE EntryType = 18
)
...
var fileDescriptor_77a6da22d6a3feb1 = []byte{
	...
	,
}
