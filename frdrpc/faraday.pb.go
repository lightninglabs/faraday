...
type ExchangeRateRequest struct {
	...
	// The currency that the bitcoin price should be quoted in.
...
func (m *ExchangeRateRequest) GetCurrency() string {
	if m != nil {
		return m.Currency
	}
	return ""
...
func (m *BitcoinPrice) GetCurrency() string {
	if m != nil {
		return m.Currency
	}
	return ""
...
type NodeAuditRequest struct {
	...
	// The currency that the price values should be quoted in.
...
func (m *NodeAuditRequest) GetCurrency() string {
	if m != nil {
		return m.Currency
	}
	return ""
...
type ReportEntry struct {
	...
	// The currency that the fiat field is expressed in.
	FiatCurrency string `protobuf:"bytes,13,opt,name=fiat_currency,json=fiatCurrency,proto3" json:"fiat_currency,omitempty"`
...
func (m *ReportEntry) GetFiatCurrency() string {
	if m != nil {
...
var fileDescriptor_9ccb88e279ed9462 = []byte{
	...
	,
}
